...
function ProjectForm({ project: initialProject, 
  ...
  return (
    <form aria-label="Edit a project" name="ProjectForm" className="input-group vertical" onSubmit={handleSubmit}>
      ...
      <textarea id="description" aria-label="project description" name="description" placeholder="enter description" value={project.description} onChange={handleChange}></textarea>
      {errors.description.length > 0 && (
        <div role="alert" className="card error">
